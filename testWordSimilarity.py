...
def testAll():
    ...
    """
    passed = True
    passed = testFileName('data/very_short.txt', 'airport', ['airport', 'wandered', 'request']) and passed
    passed = testFileName('data/a.txt', 'adj', ['adj', 'antitrust', 'adenosine', 'adenomas', 'ambulatory']) and passed
    passed = testFileName('data/all.txt', 'robot', ['robot', 'robots', 'robotics', 'neuroendocrine', 'programmable']) and passed
    print()
